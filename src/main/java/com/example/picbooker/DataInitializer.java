...
// // import com.example.picbooker.additionalService.AddOnRepository;
...
// // @Autowired
// // private AddOnRepository additionalServiceRepository;
...
// // @Transactional
// // public void initializeDefaultAddOns() {
// // Variables.defaultAddOns.forEach(additionalService -> {
// // if
// (!additionalServiceRepository.existsByType(additionalService.getType())) {

// // AddOn st = AddOn.builder().type(additionalService.getType())
