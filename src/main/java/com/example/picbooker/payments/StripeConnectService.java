...
// "http://localhost:8080/api/auth/hi?value=success";

// // @Value("${frontend.cancelUrl}") // e.g.,
...
// // these 2 in use
// @Transactional
// public String createStripeAccount(Photographer photographer) throws
// StripeException {
...
// public String getOnboardingLink(String stripeAccountId) throws
// StripeException {

// AccountLinkCreateParams params = AccountLinkCreateParams.builder()
// .setAccount(stripeAccountId)
// .setRefreshUrl("https://yourplatform.com/reauth") // Redirect if onboarding
// fails // to
// // do change
// .setReturnUrl("https://yourplatform.com/success") // Redirect after
// onboarding // to do
// // change
...
// public LoginLink getDashboardLink(Photographer photographer) throws
// StripeException {
// if (!isNull(photographer.getStripeAccountId()))
// throw new ApiException(HttpStatus.BAD_REQUEST, "You haven't set up online
// payments yet.");
...
// LoginLink loginLink = LoginLink.createOnAccount("{{CONNECTED_ACCOUNT_ID}}",
// params,
...
// public String getClientCheckoutLink(Long sessionId, Long photographerId, Long
// amountInCents, String currency)
// throws StripeException {

// // Create the checkout session
// SessionCreateParams params = SessionCreateParams.builder()
// .setMode(SessionCreateParams.Mode.PAYMENT)
// .setSuccessUrl(successUrl.replace("{CHECKOUT_SESSION_ID}",
// sessionId.toString()))
...
// public static long getSmallestAmountForCurrency(Double amount, Currency
// currency) {
// int fractionDigits = Currency.getInstance(currency.getCurrencyCode())
// .getDefaultFractionDigits();
// int factor = (int) Math.pow(10, fractionDigits);
// long amountInSmallestUnit = Math.round(amount * factor); // Use Math.round to
// handle edge
// // cases
